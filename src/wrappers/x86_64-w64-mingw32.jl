...
const libgslcblas_splitpath = ["bin", "libgslcblas-0.dll"]
...
const libgslcblas = "libgslcblas-0.dll"


# Relative path to `gsl_randist`
const gsl_randist_splitpath = ["bin", "gsl-randist.exe"]
...
const gsl_histogram_splitpath = ["bin", "gsl-histogram.exe"]
